...
package com.starredsolutions.assemblandroid.sync.authenticator;
...
import com.starredsolutions.assemblandroid.sync.client.NetworkUtilities;
...
class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response,
        ...
        Bundle options) {
    	if(LOGV) Log.v(TAG, "AddAccount (AccountType: " + accountType + ")");
    ...
    public Bundle confirmCredentials(AccountAuthenticatorResponse response,
    	...
    	if(LOGV) Log.v(TAG, "ConfirmCredentials");
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response,
    	...
    	if(LOGV) Log.v(TAG, "getAuthToken");
