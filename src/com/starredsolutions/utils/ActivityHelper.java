...
public class ActivityHelper {
     ...
     */
    public void goHome() {
        if (mActivity instanceof ProjectsListingActivity) {
            return;
        }

        final Intent intent = new Intent(mActivity, ProjectsListingActivity.class);
     ...
     */
    public void setupActionBar(CharSequence title, int color,boolean showHomeButton) {
